...
const { registerUser, loginUser, getUsers, getUser, updateUser, changeUserBusinessStatus, deleteUser } = require("./models/userDataService");
...
router.get("/:id", auth, async (req, res) => {
  try {
    ...
    if (_id !== id && !isAdmin){
        return handleError(res, 403, "Authorization Error: You must be an admin type user or the registered user to see this user details");
    }
